...
#' @export
setMethod("residuals", "blimp_obj",
function( object,...) {
    return(object@residuals)
})

#' @export
setMethod("predict", "blimp_obj",
function( object,...) {
